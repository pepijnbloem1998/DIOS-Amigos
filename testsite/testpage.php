...
/*resttest*/
  ...
  if($focus==1)
    {
      ...
      {
        $url="http://10.1.4.10:5051/valideer/" . $_POST['txt_naam'] . "/" . $_POST['txt_password'];
  ...
  if($focus==2)
   {
     $url="http://10.1.4.10:5052/hoofdstad/" . $_POST['txt_land'];
     ...
     <tr>
       <td style="border: solid black 1px";>
         <div class="form" style="text-align: left; padding:5px;height:200px">
            ...
            <br/><h3 style="color:darkred; margin:0px; padding:0px;">Probeer een Europees land.Test zinnetje</h3><br/><br/>
            <?php
              echo($html2);
            ?>
